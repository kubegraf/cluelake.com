...
const TOPICS = [
  ...
  { title: "Cardinality", body: "Budgets are per workspace and count-based. An over-budget series is refused by name and surfaced in the portal, rather than dropped quietly or billed silently." },
